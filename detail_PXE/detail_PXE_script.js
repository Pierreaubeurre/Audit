function detail() {
    ...
    fetch(`http://${iPort}/items/PXE?filter[ID_PXE][_eq]=${sessionStorage.getItem('id_equip_venant_serveur')}`, requestOptions)
...
function construction_detail(resp) {
    ...
    delete tableau[5]//enlève l'id du PXE
    delete tableau[6]//enlève l'id du serveur
