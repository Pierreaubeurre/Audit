function detail() {
    ...
    fetch(`http://${iPort}/items/VM_SECU?filter[ID_VM_SECU][_eq]=${sessionStorage.getItem('id_equip_venant_serveur')}`, requestOptions)
...
function construction_detail(resp) {
    ...
    delete tableau[11]//enlève l'id du VM SECU
    delete tableau[12]//enlève l'id du serveur
