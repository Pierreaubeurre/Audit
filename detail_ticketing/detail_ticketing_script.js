function detail() {
    ...
    fetch(`http://${iPort}/items/TICKETING?filter[ID_TICKETING][_eq]=${sessionStorage.getItem('id_equip_venant_serveur')}`, requestOptions)
...
function construction_detail(resp) {
    ...
    delete tableau[8]//enlève l'id du ticketing
    delete tableau[9]//enlève l'id du serveur

    if (tableau[3]==true){//affiche le ligne précision si necéssaire  8
